    ...
    return (
      <div className="max-w-5xl mx-auto py-8">
        <EmptyState
          ...
          description={`No member record found with ID "${patientId}".`}
          actionLabel="Back to member cohort"
    ...
    <div className="space-y-6 animate-fade-in max-w-5xl mx-auto">
      ...
      <div className="flex items-center justify-between gap-4">
        ...
        >
          ...
          <span>Back to member cohort</span>
        </Link>
      ...
      <aside
        aria-label="Member Privacy Notice"
      ...
      >
        ...
        <p className="leading-relaxed">
          <strong>Privacy guarantee:</strong> Member's raw conversation transcripts and private reflections remain on their personal device. You receive high-level continuity observations and distress trajectories to support timely human outreach.
        </p>
      </aside>
