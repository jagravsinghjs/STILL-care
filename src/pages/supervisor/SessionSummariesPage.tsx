...
export default function SessionSummariesPage() {
  ...
  return (
    ...
    >
      ...
      {/* Patient Header & Caseload Switcher */}
      <div className="bg-bone border border-charcoal/15 rounded-lg p-5 shadow-2xs space-y-3">
        ...
        >
          ...
          <p className="leading-relaxed">
            <strong>Privacy Boundary Enforced:</strong> Raw voice audio and personal transcripts are withheld at the data boundary to protect student safety and trust. Only high-level observations, distress trends, and explainable semantic summaries are presented to the supervisor.
          </p>
        </aside>
      </div>
              ...
              >
                ...
                <div className="pt-2 border-t border-charcoal/10 flex flex-col sm:flex-row sm:items-center justify-between gap-2 text-xs text-charcoal/60">
                  <div className="flex items-center gap-1.5">
                    ...
                    <span>Raw transcript protected on student device</span>
                  </div>
