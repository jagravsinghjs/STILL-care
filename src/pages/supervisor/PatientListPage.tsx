  ...
  return (
    <div className="space-y-6 animate-fade-in max-w-5xl mx-auto">
      ...
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-3 border-b border-charcoal/15 pb-4">
        <div>
          ...
          <p className="text-xs sm:text-sm text-charcoal/70 mt-1">
            Prioritized by care continuity need. Most recently active students shown first within each state.
          </p>
        </div>
      ...
      {isLoading && patients.length === 0 && (
        <LoadingState message="Loading assigned student cohort..." />
      )}
        ...
        <>
          ...
          <div className="flex flex-col md:flex-row md:items-center justify-between gap-3 bg-bone border border-charcoal/15 rounded-lg p-3 sm:p-4">
            ...
            <div
              ...
              role="tablist"
              aria-label="Filter student cohort"
            >
              <button
                type="button"
                role="tab"
          ...
          <div className="flex items-center justify-between text-xs text-charcoal/60 px-1">
            <span>Showing {filteredPatients.length} of {patients.length} assigned students</span>
          ...
          {filteredPatients.length === 0 ? (
            <EmptyState
              ...
              description={
                searchQuery
                  ? `No students found matching "${searchQuery}". Try clearing the search.`
                  : filterMode === 'needs_attention'
                  ? 'No students currently require escalated attention.'
                  : 'No student records in this view.'
              }
            ...
            <div className="space-y-4" role="feed" aria-label="Prioritized student cohort list">
