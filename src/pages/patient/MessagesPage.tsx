          ...
          <div className="flex items-center gap-3">
            ...
            <div>
              ...
              <p className="text-xs text-charcoal/70">
                Supervising Counselor &middot; Community Health & Member Support Services
              </p>
            </div>
          </div>
      ...
      <footer className="p-4 bg-paper-grey/60 border border-charcoal/15 rounded-md text-xs text-charcoal/70 flex items-start gap-3">
        ...
        <div className="space-y-1">
          ...
          <p className="leading-relaxed">
            This messaging feature is asynchronous and is not monitored continuously. It should not be used during acute emergencies. If you are feeling overwhelmed or need immediate support, please reach out directly to your campus health center, campus counseling cell, or local emergency services.
          </p>
        </div>
      </footer>
    </div>
