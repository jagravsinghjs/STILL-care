  ...
  if (isLoading) {
    return (
      <div className="py-20 flex items-center justify-center">
        <LoadingState message="Preparing your personal sanctuary..." />
      </div>
    );
  }
    ...
    >
      ...
      >
        ...
        <div className="relative z-10 max-w-2xl space-y-2">
          <div className="inline-flex items-center gap-1.5 px-2.5 py-1 rounded-full bg-sage/50 text-forest text-xs font-medium border border-forest/10 mb-1">
            <Sparkles className="w-3.5 h-3.5" />
            <span>Campus Wellbeing Sanctuary</span>
          </div>
            ...
            <div className="flex items-start gap-4">
              ...
              <div className="space-y-1">
                ...
                <p className="text-xs sm:text-sm text-charcoal-muted max-w-xl leading-relaxed">
                  You can speak aloud with conversational AI support or write at your own pace.
      ...
      <section aria-label="Quick Actions" className="grid grid-cols-2 md:grid-cols-4 gap-3 sm:gap-4">
        ...
        {/* Card 4: My Supervisor & Privacy (Soft Blue) */}
        <Link
        ...
        <div className="lg:col-span-4 space-y-6">
          ...
          <div className="bg-white border border-border-subtle rounded-2xl p-5 shadow-xs space-y-3 relative overflow-hidden">
            ...
            <div className="pt-1 pl-1 flex items-center gap-2 text-[11px] text-charcoal-muted/70">
              ...
              <span>Daily campus wellness grounding</span>
            </div>
          </div>
