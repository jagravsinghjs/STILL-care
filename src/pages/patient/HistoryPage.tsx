...
import { History, Plus, ArrowLeft, TrendingUp } from 'lucide-react';
    ...
    >
      ...
      <div className="p-4 bg-paper-grey/30 border border-charcoal/10 rounded text-xs text-charcoal/70 space-y-1 mt-6">
        ...
        <p className="leading-relaxed">
          Your private reflections and transcripts are never forwarded as raw text to your counselor.
          Only high-level themes and wellbeing patterns are shared to help your counselor notice if fatigue or pressure is building up over time.
        </p>
      </div>
    </div>
  );
