          ...
          <div className="flex items-start gap-4">
            ...
            <div className="space-y-1">
              ...
              <p className="text-xs sm:text-sm font-medium text-charcoal/80">
                Supervising Counselor &middot; Campus Wellbeing & Student Support Services
              </p>
              <p className="text-xs text-charcoal/65 max-w-xl leading-relaxed pt-1">
                Dr. Iyer reviews longitudinal care continuity observations to ensure students receive steady, compassionate guidance during demanding academic semesters and campus transitions.
              </p>
            </div>
          </div>
      ...
      <footer className="p-4 bg-paper-grey/60 border border-charcoal/15 rounded-md text-xs text-charcoal/70 flex items-start gap-3">
        ...
        <div className="space-y-1">
          ...
          <p className="leading-relaxed">
            STILL-care is designed for longitudinal care continuity and reflective check-ins, not acute emergency response. If you are feeling overwhelmed or need urgent assistance, please contact your campus health center, designated student counseling cell, or local emergency medical services.
          </p>
        </div>
      </footer>
    </div>
