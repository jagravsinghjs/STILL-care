    ...
    <div className="min-h-screen bg-bone text-charcoal flex flex-col font-sans selection:bg-clay-soft/20">
        ...
        <div className="max-w-6xl mx-auto px-4 sm:px-6 h-16 flex items-center justify-between">
          ...
          <div className="flex items-center gap-6">
            <Link
              ...
              aria-label="STILL-care Student Home"
            >
      ...
      <footer className="border-t border-charcoal/10 py-5 bg-paper-grey/30 text-center text-xs text-charcoal/60">
        <div className="max-w-6xl mx-auto px-4 flex flex-col sm:flex-row items-center justify-between gap-2">
          <span>STILL-care is a supportive listening and distress monitoring platform.</span>
          <span className="text-charcoal/50">Not a diagnostic system or replacement for professional care.</span>
        </div>
      </footer>
    </div>
  );
