    ...
    >
      ...
      {isOpen ? (
          ...
          <div className="space-y-1">
            ...
            >
              <div className="flex items-center gap-2">
                ...
                <span>Member: <strong>Ananya Sharma</strong></span>
              </div>
        ...
        <button
          ...
          title="Click to switch persona (Member / Counselor)"
        >
          <ArrowRightLeft className="w-3 h-3 text-sage" />
          <span className="text-[11px] font-medium">
            {isPatientView ? 'Member View (Ananya)' : isSupervisorView ? 'Counselor View (Dr. Iyer)' : 'Switch Perspective'}
          </span>
