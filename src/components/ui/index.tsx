...
export function Badge({children}:{children:ReactNode}){return <span className={`badge ${children==='Increasing concern'?'concern':children==='Monitoring'?'monitoring':''}`}><span/> {children}</span>}
