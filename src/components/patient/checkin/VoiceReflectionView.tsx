          ...
          <div className="space-y-6 py-4">
            ...
            <div className="space-y-1.5 max-w-md mx-auto">
              ...
              <p className="text-xs text-charcoal/70 leading-relaxed">
                When you tap start, recording will begin. You can pause or stop whenever you have shared what you would like.
              </p>
              <p className="text-[11px] text-charcoal/50 pt-1">
                Private session &middot; Your reflections remain securely on your device
              </p>
            </div>
