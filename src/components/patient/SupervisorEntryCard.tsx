...
export function SupervisorEntryCard({ supervisor }: SupervisorEntryCardProps) {
  ...
  const supervisorOrg = supervisor?.organization || 'Counseling & Wellness Services';
    ...
    >
      <div className="space-y-1.5">
        ...
        <div className="pt-1 space-y-0.5">
          ...
          <p className="text-[11px] text-charcoal/50">{supervisorOrg}</p>
        </div>
      </div>
